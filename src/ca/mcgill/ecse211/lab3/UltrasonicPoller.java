...
public class UltrasonicPoller implements Runnable {
  ...
  UltrasonicPoller(SampleProvider usDistance, UltrasonicController controller) {
	  usData = new float[Resources.US_SENSOR.sampleSize()];
	  this.sampleProvider = usDistance;
